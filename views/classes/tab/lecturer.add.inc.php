<form method="POST" class="form mx-auto" style="width: 100%; max-width: 400px; margin-top: 20px;">
  ...
  <input class="form-control" name="name" type="text" placeholder="lecturer name" value="<?= old('name') ?>" autofocus><br>
  <button class="btn btn-sm btn-success float-end" name="search">Search</button>
  <a href="/single_class?id=<?= $class['class_id'] ?>&tab=lecturer" class="btn btn-sm btn-secondary float-start">Cancel</a>
